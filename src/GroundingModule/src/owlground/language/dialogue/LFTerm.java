...
import TRIPS.KQML.*;
//import TRIPS.OWLAgent.owlbackend.*;
...
public class LFTerm implements Serializable{
	...
	private HashMap<String,KQMLObject> properties;
	private KQMLList logicalForm;
	private int coreferenceDepth = 0;
	...
	public LFTerm(String ontologicalClass, String variableName, String concept)
	{
		this.ontologicalClass = ontologicalClass;
		this.variableName = variableName;
		this.concept = concept;
	...
	/*
	 * Returns the rendered description logic form of the OWL representation of the object,
	 * and adds axioms to the LFRefConverter of this Dialogue to be written when the Dialogue
	 * has been completely parsed.
	 */
//	public String getOWLString()
//	{
//		turn.dialogue.getLFRefConverter().updateSenseKeyMappings(turn.dialogue.getWordNetMapping());
//		turn.dialogue.getLFRefConverter().updateSenseNumMappings(turn.dialogue.getWordNetSenseNumMapping());
//		//System.out.println(turn.dialogue.getWordNetMapping().size() + " word net mappings");
//		//System.out.println(turn.dialogue.getWordNetSenseNumMapping().size() + " word net sense num mappings");
//		turn.dialogue.getLFRefConverter().nameObjects = false;
//    	KQMLObject context = logicalForm.getKeywordArg(":CONTEXT");
//    	if (context instanceof KQMLList)
//    	{
//    		//KQMLList logicalFormList = new KQMLList(logicalForm);
//    		try {
//    			String result = turn.getDialogue().getLFRefConverter().render(turn.getDialogue().getLFRefConverter().convertLFToOWL(variableName,
//    																				(KQMLList)context,
//    																				turn.getWordSense(variableName),
//    																				turn.getTurnNumber()));
//
//    			return result;
//    		}
...
//	}
	...
	public String getVariableConcept(String variableName)
	{
		if (turn == null)
	...
	private static boolean isVariable(String objectStringValue)
	{
	 ...
	 * @return
	 */
	private String resolveCoreference(String variableName)
	{
	...
	private int getVariableNumber(String variableName)
	{
...
/*	public String getOWLString()
	...
	private LFTerm getLFTermById(String id)
	{
